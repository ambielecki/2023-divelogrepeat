                ...
                <div class="field">
                  <div class="control">
                    <input
                        ...
                        type="text"
                        v-model="dive_log.bottom_time_min"
                        placeholder="Max Depth (ft)"
                    >
                  </div>
                </div>
                ...
                <div class="field">
                  <div class="control">
                    <input
                        ...
                        type="text"
                        v-model="dive_log.surface_interval_min"
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                    ...
                    <label class="radio">
                      <input type="radio" name="used_computer" value="0" v-model="dive_log.used_computer">
                      No
                    </label>
                  </div>
                </div>
